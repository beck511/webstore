...
public class ProductController {
	...
	public String filterManufacturer(
			@MatrixVariable(pathVar = "manufacturer") Map<String, List<String>> filterParams,
			Model model) {
		return "manufacturer";
	...
	public String processAddNewProductForm(
		...
		if (productImage != null && !productImage.isEmpty()) {
			...
			String root2Directory = request.getSession().getServletContext()
					.getRealPath("/");

			if (pdf != null && !pdf.isEmpty()) {
				try {
					pdf.transferTo(new File(root2Directory + "resources\\pdf\\"
